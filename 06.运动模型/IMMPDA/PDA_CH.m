...
for t=1:simTime-1
    ...
    %IMMPDA算法，
%      [x1_IMM,P1_IMM,L1] = PDA_Function(x01, P01, F1, H, z_noise(:,:,t+1));
%      [x2_IMM,P2_IMM,L2] = PDA_Function(x02, P02, F2, H, z_noise(:,:,t+1));
%      [x3_IMM,P3_IMM,L3] = PDA_Function(x03, P03, F3, H, z_noise(:,:,t+1));
%      %第三步--模型概率更新
%      [u_IMM(:,t+1)] = Model_P_up_PDA(L1,L2,L3,c_j);
%     %第四步--模型综合
%     [x_pro_IMM(:,t+1),P_IMM(:,:,t+1)]=Model_mix(x1_IMM,x2_IMM,x3_IMM,P1_IMM,P2_IMM,P3_IMM,u_IMM(:,t));   
...
plot(x_pro_IMM(1,:),x_pro_IMM(3,:),'rs-');
